    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='media/users/profile_pics')),
                ('cover_photo', models.ImageField(blank=True, null=True, upload_to='media/users/cover_photos')),
